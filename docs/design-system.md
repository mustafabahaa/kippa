...
### Primary
- **Google Teal** (`#005c55`): Primary interactive elements, primary CTAs, and trusted actions
- **Google Dark Teal** (`#0f766e`): Hover and active states for primary actions
...
- Border: `0px`
- Line Height: normal
- Hover State: Background `#0f766e`
- Active State: Background `#006a61`
...
- Width: `376px`
- Line Height: normal
- Focus State: Background `#FFFFFF`, Border `2px solid #005c55`
...
- Focus State: Border `2px solid #005c55`
...
- Active Link Color: `#005c55`
- Hover Link Color: `#0f766e`
...
- Hover State: Background `#F1F3F4`
- Active State: Border Bottom `3px solid #005c55`
...
- Ensure all interactive elements have visible focus states with `2px solid #005c55` borders
