...
export const navigationOverrides = ({ tokens: t }: OverrideContext): Components<Theme> => ({
  ...
  MuiBottomNavigationAction: { styleOverrides: { root: { color: t.textSecondary, minWidth: 'auto', padding: '6px 0', '&.Mui-selected': { color: designTokens.color.primaryContainer } } } },
});
