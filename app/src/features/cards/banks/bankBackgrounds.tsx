...
/**
 * Bank card background pattern overlays: subtle full-card SVG components per
 * bank, rendered at low opacity (~0.04-0.08) on top of the tier/brand gradient.
 *
 * Gradient resolution lives in `bankGradients.ts`; the consumer (`banks.tsx`)
 * wires each bank's `background` to a gradient + one of these overlay components.
 */
