...
> ⚠️ **License:** This project is licensed under the [PolyForm Noncommercial License](./LICENSE). Free for personal and non-commercial use. For commercial use, contact YOUR_SUPPORT_EMAIL.
